    ...
    <Layout>
      <form id="formLog" className="container-sm w-50 p-3">
        ...
        <div className="input-group mt-5">
          ...
          <input placeholder="Email here" minLength="5" name="email" type="email" className="form-control" />
          <input placeholder="Password here" minLength="6" name="password" type="password" className="form-control" />
        </div>
